...
const QuizScreen = () => {
    ...
    return (
        <SafeAreaView>
            <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", padding: 10, marginTop: 45 }}>
                <Text>Quiz Challenge</Text>
                <Pressable style={{ padding: 10, backgroundColor: "#90E0EF", borderRadius: 20 }}>
